...
try {
    ...
    $mail->Password = 'gatefgokvjmflhow'; // SMTP password
    ...
    $mail->addAddress('active@daoquyenminh.onmicrosoft.com'); // Add a recipient
    ...
    // Mail body content 
    $bodyContent = '<p>Thân gửi Tân sinh viên <b>Đào Minh Quyền</b></h1>'; 
