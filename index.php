        ...
        <header class="p-3 bg-dark text-white">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <li><a href="./index.php" class="nav-link px-2 text-white"><i class="fas fa-home"></i></a></li>
                            ...
                            <table id="tbl_exporttable_to_xls" class="table table-bordered text-center table-success table-stripedr border-primary">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        $sql="SELECT nv.tennv, nv.chucvu, nv.email,nv.sodidong, dv.tendv From db_nhanvien nv, db_donvi dv where nv.madv=dv.madv";
